...
for j in range(0,1600):
    a,b,c,d,e,f = np.loadtxt('dens.T.cube',skiprows = (31+j*7),max_rows=6,unpack=True)
    a1,b1,c1,d1,e1,f1 = np.loadtxt('dens.P.cube',skiprows = (31+j*7),max_rows=6,unpack=True)
    ...
    a,b,c,d = np.loadtxt('dens.T.cube',skiprows = (31+6+j*7),max_rows=1,unpack=True)
    a1,b1,c1,d1 = np.loadtxt('dens.P.cube',skiprows = (31+6+j*7),max_rows=1,unpack=True)
...
np.savetxt('diff1.cube',arr,fmt='%s',delimiter='  ')
